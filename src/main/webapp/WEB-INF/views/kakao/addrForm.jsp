...
<h3>다음 주소</h3>
<form action="${pageContext.request.contextPath}/daum/addrresult" method="post">
...
<input type="text" name="jubunAddress" id="sample4_jibunAddress" placeholder="지번주소">
